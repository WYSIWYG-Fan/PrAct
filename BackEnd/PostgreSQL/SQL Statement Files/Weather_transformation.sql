...
select nextval('weatherdata2_id_seq'), 
	8, --IMPORTANT: Load corresponding location id from citydimension
	date.date_id, 
	medium_temperature, 
	maximum_wind, 
	sunshine_duration, 
...
from "weatherdata" as t where t.location = 'Stuttgart') AS t
...
select * from weatherdata2 where location = 8; --weatherdimension is null;
